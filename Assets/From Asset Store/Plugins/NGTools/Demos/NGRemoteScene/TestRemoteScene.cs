	...
	public class TestRemoteScene : MonoBehaviour
	{
		...
		protected virtual void	OnGUI()
		{
			...
			using (var scroll = new GUILayout.ScrollViewScope(this.scrollPosition))
			{
				...
				GUILayout.Label("3. Open a <b>NG Remote Hierarchy</b> window. You will find it in the menu at <b>Window/NG Tools/NG Remote Hierarchy</b>.", this.labelStyle);
				...
				GUILayout.Label("5. Open a <b>NG Remote Inspector</b> window. You will find it in the menu at <b>Window/NG Tools/NG Remote Inspector</b>.", this.labelStyle);
				GUILayout.Label("   This is the equivalent of Unity's <b>Inspector</b> window", this.labelStyle);

				GUILayout.Label("6. Open a <b>NG Remote Project</b> window. You will find it in the menu at <b>Window/NG Tools/NG Remote Project</b>.", this.labelStyle);
